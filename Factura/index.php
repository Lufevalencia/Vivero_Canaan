                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="txtApellidoM">Documento Proveedor</label>
                                    <input type="text" class="form-control" require name="txtApellidoM" id="txtApellidoM" placeholder="" value="<?php echo $txtApellidoM ?>">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="txtApellidoM">Código Artículo</label>
                                    <input type="text" class="form-control" require name="txtApellidoM" id="txtApellidoM" placeholder="" value="<?php echo $txtApellidoM ?>">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="txtApellidoM">Forma de Pago</label>
                                    <input type="text" class="form-control" require name="txtApellidoM" id="txtApellidoM" placeholder="" value="<?php echo $txtApellidoM ?>">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="txtApellidoM">Fecha Factura</label>
                                    <input type="text" class="form-control" require name="txtApellidoM" id="txtApellidoM" placeholder="" value="<?php echo $txtApellidoM ?>">
